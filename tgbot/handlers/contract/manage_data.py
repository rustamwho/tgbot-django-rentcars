...
SET_FINE_IS_PAID_MENU = BASE_FOR_CONTRACT_MENU + 'SET_FINE_IS_PAID_MENU'
...
CONTRACT COMMANDS
"""
BASE_CONTRACT_COMMANDS = 'CONTRACT_CMD_'

# For work with personal data
BASE_FOR_ACCEPT_PD = BASE_CONTRACT_COMMANDS + 'PD_'
PD_IS_CORRECT = BASE_FOR_ACCEPT_PD + 'IS_CORRECT'
PD_IS_WRONG = BASE_FOR_ACCEPT_PD + 'PD_WRONG'

# For work with contract medias
BASE_FOR_DOWNLOAD_CONTRACT = BASE_CONTRACT_COMMANDS + 'DOWNLOAD_'
...
BASE_FOR_FINES_COMMANDS = BASE_CONTRACT_COMMANDS + 'FINES_'
...
BASE_FOR_SET_FINE_IS_PAID = BASE_CONTRACT_COMMANDS + 'SET_FINE_IS_PAID_'
