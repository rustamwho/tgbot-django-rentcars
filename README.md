# django-telegram-bot
Sexy Django + python-telegram-bot + Celery + Redis + Postgres + Dokku + GitHub Actions template. Telegram bot with database, admin panel and a bunch of useful built-in methods.
